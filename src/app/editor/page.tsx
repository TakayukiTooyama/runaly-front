...
async function analyzeVideo(
  ...
  formData.append(
    ...
    // JSON.stringify({
    //   humanBBox: { width: 514, height: 514, x: 1091, y: 363 },
    //   caliMarkers: {
    //     leftTop: { x: 222, y: 685 },
    //     leftBottom: { x: 68, y: 731 },
    //     rightTop: { x: 1303, y: 679 },
    //     rightBottom: { x: 1357, y: 738 },
    //     origin: { x: 1316, y: 707 },
    //   },
    //   caliWidth: 7,
    // }),
  )
  // const res = await fetch('http://0.0.0.0:8080/analyze', {
  const res = await fetch('https://runaly-running-analyze.fly.dev/analyze', {
...
export default function EditorPage() {
  ...
  return (
    <>
      {isLoading && (
        <div className='absolute left-0 top-0 z-10 grid h-screen w-screen  place-content-center bg-black text-white opacity-80'>
